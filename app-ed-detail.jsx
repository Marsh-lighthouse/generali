...
// ── status helpers ──
const edStatusMeta = {
  complete: { label: "Done", color: "var(--ink)", border: "#14853D", bg: "color-mix(in srgb, #14853D 15%, var(--card))" },
  progress: { label: "In progress", color: "var(--ink)", border: "var(--accent)", bg: "color-mix(in srgb, var(--accent) 15%, var(--card))" },
  notstarted: { label: "Not started", color: "var(--ink)", border: "#94918C", bg: "var(--status-neutral-bg)" },
  locked: { label: "Locked", color: "var(--ink)", border: "#94918C", bg: "var(--status-neutral-bg)" }
};
